package org.benrush.server.common.aspect;
...
import org.benrush.server.common.exception.GeneratorException;
...
public class WebLog {
    ...
    @Pointcut("execution(public * org.benrush.server.controller..*.*(..))")
    public void webLog() {
